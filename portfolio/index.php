...
$langData = $data['lang'];
$hobbyData = $data['hobby'];
$aboutCar = $data['aboutCaree'];
?>
<!DOCTYPE html>
        ...
        <div class="sidebar-wrapper">
            ...
            <div class="contact-container container-block">
                <ul class="list-unstyled contact-list">
                    <li class="email"><i class="fa fa-envelope"></i><a href="mailto: yourname@email.com"><?= $data['about']['email']?></a></li>
                    <li><i class="fa fa-phone"></i><?= $aboutData['place']?></li>
                </ul>
            </div><!--//contact-container-->
            <div class="education-container container-block">
                <h2 class="container-block-title">Education</h2>
                <? foreach ($educData as $value) {?>
                <div class="item">
                    <h4 class="degree"><?=$value['facultet']?></h4>
                    <h5 class="meta"><?=$value['university']?></h5>
